...
const questionsBank = [
  ...
  {
    id: 11, area: "Ciências da Natureza", materia: "Biologia",
    text: "A principal função dos ribossomos na célula é:",
    options: ["Síntese de proteínas", "Respiração celular", "Digestão intracelular", "Armazenamento de água"],
    correct: 0,
    explanation: "Ribossomos traduzem o RNA mensageiro em cadeias de aminoácidos (proteínas).",
  },
  {
    id: 12, area: "Ciências da Natureza", materia: "Biologia",
    text: "Em um cruzamento entre dois indivíduos heterozigotos (Aa x Aa), a proporção fenotípica esperada é:",
    options: ["3:1", "1:1", "9:3:3:1", "2:2"],
    correct: 0,
    explanation: "Monoibridismo com dominância completa gera 3 dominantes para 1 recessivo.",
  },
  {
    id: 13, area: "Ciências da Natureza", materia: "Física",
    text: "Um carro percorre 180 km em 2 horas. Sua velocidade média é:",
    options: ["60 km/h", "80 km/h", "90 km/h", "120 km/h"],
    correct: 2,
    explanation: "Vm = ΔS/Δt = 180/2 = 90 km/h.",
  },
  {
    id: 14, area: "Ciências da Natureza", materia: "Física",
    text: "Uma força de 20 N atua sobre um corpo de 4 kg. A aceleração adquirida é:",
    options: ["2 m/s²", "5 m/s²", "10 m/s²", "80 m/s²"],
    correct: 1,
    explanation: "Pela 2ª Lei de Newton: a = F/m = 20/4 = 5 m/s².",
  },
  {
    id: 15, area: "Ciências da Natureza", materia: "Química",
    text: "O pH de uma solução neutra a 25 °C é:",
    options: ["0", "7", "10", "14"],
    correct: 1,
    explanation: "Em água pura a 25 °C, [H⁺] = 10⁻⁷ mol/L, portanto pH = 7.",
  },
  {
    id: 16, area: "Ciências da Natureza", materia: "Química",
    text: "Qual das substâncias abaixo é um composto orgânico?",
    options: ["NaCl", "CH₄", "H₂SO₄", "CO₂"],
    correct: 1,
    explanation: "O metano (CH₄) é um hidrocarboneto, composto orgânico por definição.",
  },
  {
    id: 17, area: "Ciências da Natureza", materia: "Biologia",
    text: "A eutrofização de um lago está associada principalmente ao excesso de:",
    options: ["Oxigênio dissolvido", "Nutrientes como nitrogênio e fósforo", "Metais pesados", "Radiação solar"],
    correct: 1,
    explanation: "O excesso de nutrientes provoca proliferação de algas e queda do oxigênio dissolvido.",
  },
  {
    id: 18, area: "Matemática", materia: "Matemática",
    text: "Um produto de R$ 200,00 recebeu desconto de 15%. Qual o valor final?",
    options: ["R$ 165,00", "R$ 170,00", "R$ 175,00", "R$ 185,00"],
    correct: 1,
    explanation: "200 × 0,85 = 170.",
  },
  {
    id: 19, area: "Matemática", materia: "Matemática",
    text: "Qual é a média aritmética dos números 4, 8, 10 e 18?",
    options: ["9", "10", "11", "12"],
    correct: 1,
    explanation: "(4+8+10+18)/4 = 40/4 = 10.",
  },
  {
    id: 20, area: "Matemática", materia: "Matemática",
    text: "A função f(x) = 2x + 3 tem raiz igual a:",
    options: ["-3/2", "3/2", "-2/3", "2/3"],
    correct: 0,
    explanation: "2x + 3 = 0 → x = -3/2.",
  },
  {
    id: 21, area: "Matemática", materia: "Matemática",
    text: "Um cubo tem aresta de 5 cm. Seu volume é:",
    options: ["25 cm³", "75 cm³", "100 cm³", "125 cm³"],
    correct: 3,
    explanation: "V = a³ = 5³ = 125 cm³.",
  },
  {
    id: 22, area: "Matemática", materia: "Matemática",
    text: "Numa progressão geométrica de razão 3 e primeiro termo 2, o quarto termo é:",
    options: ["18", "27", "54", "81"],
    correct: 2,
    explanation: "a₄ = 2 × 3³ = 2 × 27 = 54.",
  },
  {
    id: 23, area: "Matemática", materia: "Matemática",
    text: "Qual a probabilidade de sair um número par ao lançar um dado comum?",
    options: ["1/6", "1/3", "1/2", "2/3"],
    correct: 2,
    explanation: "São 3 números pares em 6 possibilidades: 3/6 = 1/2.",
  },
  {
    id: 24, area: "Matemática", materia: "Matemática",
    text: "Se log₁₀(1000) = x, então x vale:",
    options: ["2", "3", "10", "100"],
    correct: 1,
    explanation: "10³ = 1000, logo x = 3.",
  },
  {
    id: 25, area: "Linguagens", materia: "Português",
    text: "Assinale a frase em que a crase foi empregada corretamente:",
    options: [
      "Vou à escola todos os dias.",
      "Cheguei à pé na aula.",
      "Refiro-me à ele.",
      "Começou à chover cedo.",
    ],
    correct: 0,
    explanation: "Crase ocorre na fusão da preposição 'a' com o artigo 'a' antes de palavra feminina.",
  },
  {
    id: 26, area: "Linguagens", materia: "Português",
    text: "A função da linguagem centrada no receptor, com intenção de convencer, é a:",
    options: ["Emotiva", "Conativa", "Fática", "Metalinguística"],
    correct: 1,
    explanation: "A função conativa (ou apelativa) busca influenciar o interlocutor, típica da publicidade.",
  },
  {
    id: 27, area: "Linguagens", materia: "Literatura",
    text: "O Romantismo brasileiro tem como característica marcante:",
    options: [
      "A objetividade científica",
      "A idealização do amor e da natureza",
      "O rigor formal greco-latino",
      "A crítica social pelo determinismo",
    ],
    correct: 1,
    explanation: "O Romantismo valoriza o sentimento, a idealização amorosa e a natureza nacional.",
  },
  {
    id: 28, area: "Linguagens", materia: "Português",
    text: "Em 'Ele comprou um Portinari', ocorre a figura de linguagem:",
    options: ["Metonímia", "Metáfora", "Eufemismo", "Antítese"],
    correct: 0,
    explanation: "Metonímia: uso do autor pela obra.",
  },
  {
    id: 29, area: "Linguagens", materia: "Português",
    text: "Qual alternativa apresenta um conectivo de conclusão adequado para a redação?",
    options: ["Entretanto", "Portanto", "Embora", "Todavia"],
    correct: 1,
    explanation: "'Portanto' introduz conclusão; os demais indicam oposição ou concessão.",
  },
  {
    id: 30, area: "Linguagens", materia: "Literatura",
    text: "A Semana de Arte Moderna de 1922 marcou o início do:",
    options: ["Parnasianismo", "Modernismo", "Realismo", "Simbolismo"],
    correct: 1,
    explanation: "O evento inaugurou o Modernismo brasileiro, rompendo com padrões acadêmicos.",
  },
  {
    id: 31, area: "Ciências Humanas", materia: "Geografia",
    text: "O bioma brasileiro com maior biodiversidade e clima equatorial úmido é:",
    options: ["Cerrado", "Caatinga", "Amazônia", "Pampa"],
    correct: 2,
    explanation: "A Amazônia possui a maior biodiversidade e clima equatorial quente e úmido.",
  },
  {
    id: 32, area: "Ciências Humanas", materia: "Geografia",
    text: "O êxodo rural no Brasil intensificou-se principalmente por causa da:",
    options: [
      "Mecanização do campo e industrialização urbana",
      "Redução das cidades industriais",
      "Reforma agrária ampla e concluída",
      "Queda da população urbana",
    ],
    correct: 0,
    explanation: "A mecanização reduziu postos no campo enquanto a indústria atraía trabalhadores para as cidades.",
  },
  {
    id: 33, area: "Ciências Humanas", materia: "História",
    text: "A Era Vargas (1930-1945) é marcada pela:",
    options: [
      "Ampliação dos direitos trabalhistas e centralização do poder",
      "Adoção do parlamentarismo",
      "Abertura política total e eleições livres",
      "Extinção do Estado brasileiro",
    ],
    correct: 0,
    explanation: "Vargas criou a CLT e centralizou o poder, especialmente durante o Estado Novo.",
  },
  {
    id: 34, area: "Ciências Humanas", materia: "Sociologia",
    text: "Segundo Max Weber, a ação social é aquela que:",
    options: [
      "Independe do sentido atribuído pelo indivíduo",
      "Leva em conta o comportamento de outros e é orientada por sentido",
      "Ocorre apenas em sociedades industriais",
      "É determinada exclusivamente pela economia",
    ],
    correct: 1,
    explanation: "Weber define ação social como conduta dotada de sentido e orientada pelo outro.",
  },
  {
    id: 35, area: "Ciências Humanas", materia: "Filosofia",
    text: "O 'mito da caverna' é uma alegoria de:",
    options: ["Aristóteles", "Platão", "Sócrates", "Descartes"],
    correct: 1,
    explanation: "A alegoria da caverna aparece em 'A República', de Platão.",
  },
  {
    id: 36, area: "Ciências Humanas", materia: "Geografia",
    text: "O efeito estufa intensificado está diretamente relacionado ao aumento de:",
    options: ["Gás carbônico e metano na atmosfera", "Oxigênio atmosférico", "Nitrogênio livre", "Vapor de hélio"],
    correct: 0,
    explanation: "CO₂ e CH₄ retêm calor, intensificando o aquecimento global.",
  },
];
